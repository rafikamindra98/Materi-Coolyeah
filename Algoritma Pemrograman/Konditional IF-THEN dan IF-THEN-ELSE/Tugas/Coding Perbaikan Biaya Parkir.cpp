...
int main(){
	...
	int jam1, jam2, jam3, menit1, menit2, menit3, detik1, detik2, detik3, durasi1, durasi2, durasi3, sisa, biaya1, biaya2;
	//ALGORITMA
	...
	menit3 = sisa/60;
	detik3 = sisa%60;
	biaya1 = jam3*BiayaPerJam;
	biaya2 = jam3*BiayaPerJam+BiayaPerJam;
	if ((menit3==0)and(detik3==0)){
		cout<<""<<endl;
		cout<<"Lama Kendaraan Parkir="<<jam3<<"Jam"<<menit3<<"Menit"<<detik3<<"Detik"<<endl;
		cout<<"Biaya Parkir="<<biaya1<<endl;
	}
	else {
		cout<<""<<endl;
		cout<<"Lama Kendaraan Parkir="<<jam3<<"Jam"<<menit3<<"Menit"<<detik3<<"Detik"<<endl;
		cout<<"Biaya Parkir="<<biaya2<<endl;
	}
