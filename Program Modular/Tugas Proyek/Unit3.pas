...
procedure TFormUtama.onMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
...
procedure TFormUtama.ikanTimeTimer(Sender: TObject);
begin
  Ikan.Visible := true;
...
procedure TFormUtama.waktuTimeTimer(Sender: TObject);
begin
...
procedure TFormUtama.btnMainClick(Sender: TObject);
begin
...
procedure TFormUtama.KeluarClick(Sender: TObject);
begin
  Form5.Show;
  FormUtama.Hide;
end;
