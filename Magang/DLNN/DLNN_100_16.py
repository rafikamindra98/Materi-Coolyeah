...
# Train the model with increased epochs and capture the training history
history = model.fit(X_train_scaled, y_train_scaled, epochs=100, batch_size=16, validation_split=0.2, callbacks=[early_stopping])
