...
print(data.head())
print("\nFeatures being used:", data.columns.tolist())
...
# Print shape and sample of scaled data
print("\nScaled data shapes:")
...
print("Format: [Pengangkutan, Libur]")
...
def create_dataset(dataset):
    ...
    y = dataset[:, 0]  # First column (Pengangkutan) is our target
    return X, y
