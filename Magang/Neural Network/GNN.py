...
# Create the graph structure: nodes connected based on date (edges between consecutive nodes)
window_size = 5  # Number of date steps to consider as neighbors
...
print(f'Average Cross-Validation Loss: {avg_val_loss:.6f}')
